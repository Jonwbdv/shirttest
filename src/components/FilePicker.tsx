    ...
    return (
        <div className="filepicker-container">
            ...
            <div className="mt-4 flex flex-wrap gap-3">
                <CustomButton type="outline" title="Logo" handleClick={() => readFile("logo")} customStyles="text-xs w-full"/>
            </div>
            <div className="mt-4 flex flex-wrap gap-3">
                <CustomButton type="filled" title="Full" handleClick={() => readFile("full")} customStyles="text-xs w-full"/>
            </div>
        </div>
    )
}
